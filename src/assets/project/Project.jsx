...
const PROJECTS = [
  ...
  },
  {
    ...
    liveUrl: "https://face-expression-frentend-eta.vercel.app",
    codeUrl: "https://github.com/SsuryaTyagi/FaceExpression-Frentend",
    status: "live",
  },
  {
  id: "nextjs-dashboard",
  image: "/Screenshot 2026-06-25 021155.png",
  tag: "Full-Stack / Next.js",
  title: "Next.js Invoice Dashboard",
  desc: "A full-stack invoicing dashboard built while following the official Next.js Learn course, featuring authentication, server actions, and PostgreSQL-backed CRUD operations.",
  points: [
    "Credentials-based authentication with NextAuth.js, bcrypt password hashing, and protected routes via Proxy",
    "Invoice CRUD (create, edit, delete) using Next.js Server Actions with Zod validation",
    "PostgreSQL database queries for customers, invoices, and revenue data",
    "Dashboard charts and cards built with dynamic, server-rendered data fetching",
  ],
  stack: [
    "Next.js",
    "React",
  ...
  liveUrl: "https://next-js-dashboard-seven-lake.vercel.app",
  codeUrl: "https://github.com/SsuryaTyagi/next.js-Dashboard",
  status: "live",
},
];
